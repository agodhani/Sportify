...
struct EventsView: View {
    ...
    var body: some View {
        ...
        @State var currentUser = User(id: "UhbWVV0lTbRd8aY4j4BhVtcyVgo1", name: "test current user", email: "current@gmail.com", radius: 0, zipCode: "47906", sportsPreferences: [], privateAccount: false, profilePicture: "ERROR", age: 0, birthday: Date(), friendList: [], blockList: [], eventsAttending: ["005861C7-AB71-48EF-B17A-515E88AA0D4B"], eventsHosting: [], suggestions: [], notifications: [], messageList: [], generalNotifications: true, dmNotifications: true, eventNotifications: true, friendRequestNotifications: true) // REAL - comment
