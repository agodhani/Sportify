...
struct UserDetailsView: View {
    ...
    @State var user: User = User(id: "ERROR", name: "ERROR", email: "ERROR", radius: 0, zipCode: "ERROR", sportsPreferences: [], privateAccount: false, profilePicture: "ERROR", age: 0, birthday: Date(), friendList: [], blockList: [], eventsAttending: [], eventsHosting: [], suggestions: [], notifications: [], messageList: [], generalNotifications: true, dmNotifications: true, eventNotifications: true, friendRequestNotifications: true)
            ...
            Color.black.ignoresSafeArea()
                .onAppear(perform: { // get the user from the DB based on ID passed in
                    ref.child("Users").child(userID).getData(completion: { error, snapshot in
                        ...
                        user = snapshot?.value as? User ?? User(id: "ERROR", name: "ERROR", email: "ERROR", radius: 0, zipCode: "ERROR", sportsPreferences: [], privateAccount: false, profilePicture: "ERROR", age: 0, birthday: Date(), friendList: [], blockList: [], eventsAttending: [], eventsHosting: [], suggestions: [], notifications: [], messageList: [], generalNotifications: true, dmNotifications: true, eventNotifications: true, friendRequestNotifications: true);
                    });
                });
