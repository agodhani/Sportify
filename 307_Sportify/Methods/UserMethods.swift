...
class UserMethods: ObservableObject {
    ...
    func getUser(user_id: User.ID) async -> User {
        do {
            ...
            return User(id: "", name: "", email: "", radius: 0, zipCode: "", sportsPreferences: Set<Int>(), privateAccount: false, profilePicture: "", age: 0, birthday: Date.now, friendList: Array<String>(), blockList: Array<String>(), eventsAttending: [String](), eventsHosting: [String](), suggestions: [String]())
        }
    }
}
